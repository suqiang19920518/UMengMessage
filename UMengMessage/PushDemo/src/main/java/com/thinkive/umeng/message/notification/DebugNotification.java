package com.thinkive.umeng.message.notification;
...
public class DebugNotification {
    ...
    public static void transmission(final Context mContext, final Handler handler) {
        try {
            final AndroidUnicast unicast = new AndroidUnicast("59c1c7cb310c935048000012", "y6t54tcixjtvsfu3hvbd1tb6geufgb34");
